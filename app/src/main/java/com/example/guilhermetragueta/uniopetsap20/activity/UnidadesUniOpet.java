...
public class UnidadesUniOpet extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unidades_uniopet);
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(this);
        retorno = Utility.checkPermission(UnidadesUniOpet.this);
        ...
        switch (requestCode) {
            case Utility.MY_PERMISSIONS_REQUEST_LOCATION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(UnidadesUniOpet.this, "Problemas durante a permissão de uso do GPS.",
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(Utility.checkPermission(UnidadesUniOpet.this)) {
            mFusedLocationClient.getLastLocation()
                    .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                        @Override
                        public void onSuccess(Location location) {
                            if (location != null) {
                               Geocoder geocoder = new Geocoder(UnidadesUniOpet.this, Locale.getDefault());
    ...
    private void callActivity(Class newActivity) {
        Intent newIntent = new Intent(UnidadesUniOpet.this,newActivity);
